class pendulum_4 {
  ...
  pendulum_4(float wl, String index) {
    ...
    for (int i = 0; i < this.path.length; i++) {
      float x = this.l * sin(angle("th"+this.index+"1", 0)) + this.l * sin(angle("th"+this.index+"2", 0)) + this.l * sin(angle("th"+this.index+"3", 0)) + this.l * sin(angle("th"+this.index+"4", 0));
      float y = this.l * cos(angle("th"+this.index+"1", 0)) + this.l * cos(angle("th"+this.index+"2", 0)) + this.l * cos(angle("th"+this.index+"3", 0)) + this.l * cos(angle("th"+this.index+"4", 0));
  ...
  void updatePath(int time) {
    ...
    this.path[0].x = this.l * sin(angle("th"+this.index+"1", time)) + this.l * sin(angle("th"+this.index+"2", time)) + this.l * sin(angle("th"+this.index+"3", time)) + this.l * sin(angle("th"+this.index+"4", time));
    this.path[0].y = this.l * cos(angle("th"+this.index+"1", time)) + this.l * cos(angle("th"+this.index+"2", time)) + this.l * cos(angle("th"+this.index+"3", time)) + this.l * cos(angle("th"+this.index+"4", time));
  }
